  ...
  axios.post('http://localhost:8000/clinicalsapi/clinicals',data).then(res=>{
    ...
    return (
      <div>
       ...
       <form>
      Patient Id: <input type="text" value={props.match.params.patientId} name="patientId" align="left" />
      Clinical Entry Type: <select name="componentName" onChange={e=>setComponentName(e.target.value)}>
